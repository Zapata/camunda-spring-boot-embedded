...
public class CamundaWebAppInitializer implements ServletContextInitializer {
	public static final Logger LOGGER = LoggerFactory
			.getLogger(CamundaWebAppInitializer.class);
	...
	public void onStartup(ServletContext servletContext)
		...
		registerFilter("Security Filter", SecurityFilter.class,
				securityFilterParameters, "/*");

		registerFilter("Cockpit Client Plugins Filter",
				CockpitClientPluginsFilter.class,
				"/app/cockpit/cockpit-bootstrap.js", "/app/cockpit/cockpit.js");

		registerFilter("Admin Client Plugins Filter",
				AdminClientPluginsFilter.class,
				"/app/admin/admin-bootstrap.js", "/app/admin/admin.js");
		...
		registerServlet("Cockpit Api", ServletContainer.class,
				cockpitApiParameters, "/api/cockpit/*");
		...
		registerServlet("Admin Api", ServletContainer.class,
				adminApiParameters, "/api/admin/*");
		...
		registerServlet("Engine Api", ServletContainer.class,
				engineApiParameters, "/api/engine/*");
	}
	...
	private FilterRegistration registerFilter(final String filterName,
		...
		if (filterRegistration == null) {
			filterRegistration = servletContext.addFilter(filterName,
					filterClass);
			...
			LOGGER.debug("Filter {} for URL {} registered.", filterName,
					urlPatterns);
		}
	...
	private ServletRegistration registerServlet(final String servletName,
		...
		if (servletRegistration == null) {
			servletRegistration = servletContext.addServlet(servletName,
					servletClass);
			servletRegistration.addMapping(urlPatterns);
			servletRegistration.setInitParameters(initParameters);

			LOGGER.debug("Servlet {} for URL {} registered.", servletName,
					urlPatterns);
		}
